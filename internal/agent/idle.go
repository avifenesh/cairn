...
func buildDecisionPrompt(soulContent, briefing string, obs *Observations, recentActions []ActivityEntry) string {
	...
	b.WriteString("**task** — Submit a lightweight task for yourself to execute on the next tick (80 rounds).\n")
	...
	b.WriteString("**code** — Start an autonomous coding session in an isolated worktree (400 rounds).\n")
